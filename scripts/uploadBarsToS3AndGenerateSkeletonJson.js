...
const LOCAL_NEW_BAR_PHOTO_BASE_DIR = path.resolve(__dirname, '../../new_dining');
const LOCAL_PROCESSED_PHOTO_OUTPUT_DIR = path.resolve(__dirname, '../../processed-dining');
...
const OUTPUT_JSON_FILENAME = 'new-dining-ske.json';
